...
st.markdown("<h1 style='text-align: center;'>Creatividad Dual: Comunicación Visual y Programación</h1>", unsafe_allow_html=True)
...
texto = """
¡Hola! Soy Kasen Liu Li, un apasionado de la narración visual y de encontrar formas creativas de conectar ideas y emociones.

Estoy estudiando Comunicación Audiovisual, un campo que me permite explorar y crear contenido visual y sonoro para comunicar y conectar con diferentes audiencias.

Me encanta la libertad creativa que brinda. Puedo contar historias, explorar diferentes ángulos y técnicas, y experimentar con la luz, el sonido y el movimiento para generar impacto. Cada proyecto es una oportunidad de ver el mundo desde otra perspectiva.

Me gustaría producir contenido audiovisual que impacte e inspire a las personas. Me veo trabajando en documentales o producciones cinematográficas que aborden temas de interés social y cultural.

En mi tiempo libre disfruto ver películas, especialmente aquellas que experimentan con narrativas visuales únicas. También me gusta practicar fotografía y explorar técnicas de edición que luego aplico en mis proyectos.
"""
...
texto_2 = """
Al principio, aprender a programar fue desafiante y algo intimidante. No estaba acostumbrada a la lógica estructurada y a pensar en bloques de código, pero tenía mucha curiosidad.

La programación me ha enseñado a resolver problemas de forma más sistemática y a pensar en cómo las piezas se conectan para crear algo funcional. Es una habilidad que aplica mucho a la creación de proyectos audiovisuales en los aspectos técnicos.

Lo que me gusta es que cada línea de código es como un puzzle, puedes ser creativo y detallista para llegar a la solución. Lo que menos me gusta es que puede ser frustrante cuando hay errores difíciles de arreglar.

Me gustaría aplicar mis conocimientos de programación para desarrollar herramientas interactivas o aplicaciones que puedan complementar el contenido audiovisual y mejorar la experiencia de las audiencias.
"""
...
if grafico_seleccionado == 'Frecuencia de las palabras Claves en los Comentarios 1':
    sidebar.markdown("<div style='text-align: justify; font-size: 20px;'>El gráfico muestra la frecuencia de palabras clave en comentarios. La palabra paro destaca como la más frecuente, lo que sugiere que es un tema importante en los comentarios analizados. Le siguen las palabras ley, dina, y bukele, aunque con menor frecuencia, lo cual indica que también se mencionan pero no con la misma intensidad que paro. Este gráfico refleja un enfoque en temas de relevancia política y social.</div>", unsafe_allow_html=True)
    ...
    sidebar.markdown("<div style='text-align: justify'>Este gráfico horizontal de frecuencia de palabras clave muestra que tecnología es el término más frecuente, seguido por educación y sociedad. Esto sugiere que los comentarios analizados están muy enfocados en temas relacionados con el avance tecnológico y su impacto en la educación y la sociedad. Otras palabras, como cultura y comunicación, también aparecen con frecuencia, mostrando interés en aspectos culturales y de interacción social.</div>", unsafe_allow_html=True)
    ...
    sidebar.markdown("<div style='text-align: justify'>Similar al segundo, este gráfico también muestra la frecuencia de palabras clave en los comentarios. Nuevamente, tecnología y educación son las palabras más destacadas, lo que confirma el énfasis en estos temas. Cultura, sociedad y comunicación mantienen una presencia notable, resaltando la importancia de estos aspectos en los comentarios. Este gráfico refuerza la observación de que los temas tecnológicos y educativos dominan la discusión.</div>", unsafe_allow_html=True)
